...
async def start_command(client: Client, message: Message):
    ...
    owner_id = ADMINS + ['1425888381']  # Fetch the owner's ID from config
    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"Your token successfully verified and valid for: 24 Hour\n\n Enjoy guys for next 24 hours you open any post direct", reply_markup=reply_markup, protect_content=True, quote=True)
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                full_tut_url = f"https://t.me/Hanime_God_Backup/66"
...
@Bot.on_message(filters.private & filters.command('broadcast') & filters.user(ADMINS + ['1425888381']))
